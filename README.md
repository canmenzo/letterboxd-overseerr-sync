...
| **[ListSync](https://github.com/Woahai321/list-sync)** | Imports IMDb / Trakt / TMDB / Letterboxd lists into Overseerr & Jellyseerr. Web dashboard, Docker. | The closest existing option and worth a look. But it drives **headless Chrome** for Letterboxd, matches films by **fuzzy title search**, and its media-type guesser treats any title with a colon as a TV show — so *Dune: Part Two* is requested as a series. |
